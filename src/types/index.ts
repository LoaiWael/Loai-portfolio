...
export type technologyKeys = 'c4d' | 'picsart' | 'lightroom' | 'figma' | 'adobeColor' | 'html' | 'css' | 'js' | 'jquery' | 'bootstrap' | 'stitch' | 'typescript' | 'react' | 'vite' | 'tailwind' | 'motion' | 'cursor' | 'github' | 'git' | 'vercel' | 'v0';
