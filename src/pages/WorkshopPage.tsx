      ...
      <main className='workshop'>
        <section className="workshop">
          ...
          <ul className="navigations">
            ...
            </svg></a><span>Websites.</span></li>
            <li id="open-source"><a href="#" ><svg
              xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
            ...
            </svg></a><span>Open source.</span></li>
            <li id="ui-ux"><a href="#"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            </svg></a><span>UI UX.</span></li>
            <li id="modeling"><a href="#" ><svg xmlns="http://www.w3.org/2000/svg"
